<script type="text/javascript">
 // <![CDATA[
    function makeZajawkaPreview(){
        alert("makeZajawkaPreview");
    }
    
    function makeShortPreview(){
        alert("makeShortPreview");
    }

    function setNewsShortText(lang){
        var ed = tinyMCE.get('newShortText');
        $.ajax({
            url: "<?php echo site_url('panel/galleries/modify'); ?>",
            type: "post",
            data: {id: <?php echo $galleryID; ?>,
                what: ("news_short_desc_" + lang),
                val: ed.getContent()
            },
            success: function(){
    ...
    function setShortText(lang){
        var ed = tinyMCE.get('shortText');
        $.ajax({
            url: "<?php echo site_url('panel/galleries/modify'); ?>",
            type: "post",
            data: {id: <?php echo $galleryID; ?>,
                what: ("short_desc_"+lang),
                val: ed.getContent()
            },
            success: function(){
                alert("Tekst zmieniony");
