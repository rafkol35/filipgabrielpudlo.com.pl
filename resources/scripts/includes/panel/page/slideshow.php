<script type="text/javascript">
    ...
    function assocSlideshowAlbum(mi){
        //console.log(mi);
        //console.log($(mi));
        ...
        $.ajax({
            url: "<?php echo site_url('panel/page/setSlideShowAlbum').'/'; ?>" + albumid.substr(3),
            type: "post",
            data: { 
//                whatID: 'id',
//                id: agaid,
//                what: 'album_id',
    ...
    function changeSlideShowSpeed(){
        //alert('asdf ' + $("#ssSpeedNumber").val());
        $.ajax({
            url: "<?php echo site_url('panel/page/setSlideShowSpeed').'/'; ?>" + $("#ssSpeedNumber").val(),
            type: "post",
            data: {},
            success: function(data){ 
            },
